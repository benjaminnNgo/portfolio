      ...
      <div className='intro h-screen flex items-center text-center justify-center m-auto'>
        <div>
          <motion.img
            ...
            className='m-auto mb-6' alt='' src='./assets/img/gbaoLogo.PNG' style={{ width: '150px' }} ></motion.img>
          <motion.h1
            variants={fadeDown}
            initial='hidden'
            animate='visible'
            transition={{ duration: 1.2 }}
            className='my_name mb-2'>Bao Ngo</motion.h1>
          <motion.span
            variants={fade}
            initial='hidden'
            animate='visible'
          ...
          >
            I'm
            <Typewriter onInit={(typewiter) => {
              typewiter.typeString(" a first year student ! ")
                .pauseFor(2000)
                .deleteAll()
